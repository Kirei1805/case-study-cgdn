    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h5><i class="fas fa-seedling me-2"></i>Plant Shop</h5>
                    <p>Chuyên cung cấp các loại cây cảnh chất lượng cao, phù hợp cho văn phòng, nhà ở và không gian sống của bạn.</p>
                </div>
                <div class="col-md-4">
                    <h5>Liên hệ</h5>
                    <ul class="list-unstyled">
                        ...
                        <li><i class="fas fa-envelope me-2"></i>info@plantshop.com</li>
                    </ul>
                </div>
                <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-6">
                    <p>&copy; 2024 Plant Shop. Tất cả quyền được bảo lưu.</p>
                </div>
