...
<head>
    ...
    <title>Sản phẩm đánh giá cao - Admin Dashboard</title>
...
<body class="bg-light">
    ...
    <div class="container-fluid py-4">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <h1 class="h3 mb-0">
                    <i class="fas fa-star me-2"></i>Sản phẩm đánh giá cao
                </h1>
                <p class="text-muted">Thống kê sản phẩm được đánh giá tốt nhất</p>
            </div>
        </div>
                        ...
                        <form method="get" class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <div>
                                    ...
                                    <a href="${pageContext.request.contextPath}/admin/statistics/top-rated" class="btn btn-secondary">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0">
                            <i class="fas fa-star me-2"></i>Top ${limit} sản phẩm đánh giá cao
                        </h5>
                    </div>
                    <div class="card-body">
                        <c:choose>
                            <c:when test="${empty topRated}">
                            ...
                            <c:otherwise>
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            <c:forEach var="product" items="${topRated}" varStatus="status">
                                                <tr>
                                                    <td>
                                                        <span class="badge bg-warning">${status.index + 1}</span>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-info">${product.reviewCount}</span>
                                                    </td>
                                                </tr>
                                            </c:forEach>
                                        </tbody>
